...
# The ESN functions for training from that data
...
# train reservoir
x,Wout,A,Win = train_reservoir(res_params,measurements[:,shift_data:shift_data+res_params['train_length']])

# predi
output, _ = predict(A, Win,res_params,x,Wout)
np.save('Expansion_Xi^2_'+'R_size_train_'+str(res_params['train_length'])+'_Rd0.1.npy',output)
